        ...
        <>
            ...
            <div className="px-6 md:px-16 lg:px-32 py-16 flex flex-col md:flex-row justify-between">
                <form onSubmit={onSubmitHandler} className="w-full">
                    ...
                    <button type="submit" className="max-w-sm w-full mt-6 bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 hover:bg-gradient-to-r hover:from-purple-700 hover:to-pink-600 uppercase">
                        Save address
                    </button>
                </form>
                <Image
